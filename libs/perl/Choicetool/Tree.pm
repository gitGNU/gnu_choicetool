...
sub pack ($) {
	...
	if (ref($child_ref)) {
	    assert(UNIVERSAL::isa(${$child_ref}, "Choicetool::Tree"));
...
sub child () {
	...
	assert(UNIVERSAL::isa(${$node_ref}, "Choicetool::Tree"));
...
sub parent () {
	...
	assert(UNIVERSAL::isa(${$parent}, "Choicetool::Tree"));
