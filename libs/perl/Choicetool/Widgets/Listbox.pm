...
package Choicetool::Widgets::Listbox;
...
sub m4ify_header ($$)
{
    ...
    return $prefix . "_CT_WIDGETS_LISTBOX_HEADER([" . $self->id() . "])\n";
}
...
sub m4ify_body ($$)
{
    ...
    return $prefix . "_CT_WIDGETS_LISTBOX_BODY([" . $self->id() . "])\n";
}
...
sub m4ify_footer ($$)
{
    ...
    return $prefix . "_CT_WIDGETS_LISTBOX_FOOTER([" . $self->id() . "])\n";
}
