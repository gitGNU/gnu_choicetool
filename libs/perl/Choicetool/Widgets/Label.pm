...
package Choicetool::Widgets::Label;
...
sub m4ify_header ($$)
{
    ...
    return $prefix . "_CT_WIDGETS_LABEL_HEADER([" . $self->id() . "])\n";
}
...
sub m4ify_body ($$)
{
    ...
    return $prefix . "_CT_WIDGETS_LABEL_BODY([" . $self->id() . "])\n";
}
...
sub m4ify_footer ($$)
{
    ...
    return $prefix . "_CT_WIDGETS_LABEL_FOOTER([" . $self->id() . "])\n";
}
