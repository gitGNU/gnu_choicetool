	...
	"It should work with (and even without) the autotools.")
     ...
     (p
      ...
      (a (@ (href "http://git.savannah.nongnu.org/gitweb/?p=choicetool.git"))
         "Git repository")
      " of this project with your web browser. This gives you a good picture "
      "of the current status of the source files. You may also view the "
      "complete histories of any file in the repository as well as "
