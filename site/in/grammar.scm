...
choice_option: 'T_PROMPT' words newlines | 'T_PROMPT' words 'T_IF' expr newlines | choice_type_definition words 'T_IF' expr newlines | choice_type_definition words newlines | choice_type_definition newlines | 'T_OPTIONAL' newlines | 'T_DEFAULT' word newlines | 'T_DEFAULT' word 'T_IF' expr newlines ;
choice_type_definition: 'T_BOOL' | 'T_TRISTATE' | 'T_STRING' | 'T_HEX' | 'T_INT' ;
...
config_option: config_type_default_definition expr newlines | config_type_default_definition expr 'T_IF' expr newlines | config_type_definition words 'T_IF' expr newlines | config_type_definition words newlines | config_type_definition newlines | 'T_PROMPT' words newlines | 'T_PROMPT' words 'T_IF' expr newlines | 'T_DEFAULT' expr newlines | 'T_DEFAULT' expr 'T_IF' expr newlines | 'T_SELECT' word newlines | 'T_SELECT' word 'T_IF' expr newlines | 'T_RANGE' word word newlines | 'T_RANGE' word word 'T_IF' expr newlines ;
config_type_definition: 'T_BOOL' | 'T_TRISTATE' | 'T_STRING' | 'T_HEX' | 'T_INT' ;
config_type_default_definition: 'T_DEF_TRISTATE' | 'T_DEF_BOOL' ;
