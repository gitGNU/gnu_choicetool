...
(p "Choicetool is a configuration management tool like "
   ...
   ".")
(h3 "COPYING")
(p "Choicetool is licensed under the "
...
(h3 "MAILING LISTS")
(p "Choicetool has a single moderated mailing list, with an archive. "
   ...
   (a (@ (href "http://lists.nongnu.org/mailman/listinfo/choicetool-generic") )
      "Choicetool mailing list page")
   " for more information on subscribing to the mailing list.")

(h3 "REPORT A BUG")
(p "If you think you have found a bug in Choicetool then please send as "
   "complete a report as possible to <choicetool AT nongnu.org>. An easy way "
...
(br)
(p "If you have a patch for a bug in Choicetool that hasn't yet been fixed in "
