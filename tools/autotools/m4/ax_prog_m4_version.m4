...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="chrome=1">
        <title>m4/ax_prog_m4_version.m4 at master from salvestrini's build-utils - GitHub</title>
    ...
    <ul class="actions">
        ...
        <li>
          ...
          <a href="/salvestrini/build-utils/toggle_watch" class="minibutton btn-watch " id="unwatch_button" style="display:none"><span><span class="icon"></span>Unwatch</span></a>
            ...
            <li class="for-notforked" style="display:none"><a href="/salvestrini/build-utils/fork" class="minibutton btn-fork " id="fork_button" onclick="var f = document.createElement('form'); f.style.display = 'none'; this.parentNode.appendChild(f); f.method = 'POST'; f.action = this.href;var s = document.createElement('input'); s.setAttribute('type', 'hidden'); s.setAttribute('name', 'authenticity_token'); s.setAttribute('value', 'ee391411770ee9204385ef84fe602e6ca2a257dd'); f.appendChild(s);f.submit();return false;"><span><span class="icon"></span>Fork</span></a></li>
  ...
  <ul>
    ...
    <div id="repo_details" class="metabox clearfix">
      ...
      <div id="repository_description_edit" style="display:none;" class="inline-edit">
        <form action="/salvestrini/build-utils/edit/update" method="post"><div style="margin:0;padding:0"><input name="authenticity_token" type="hidden" value="ee391411770ee9204385ef84fe602e6ca2a257dd" /></div>
...
<script type="text/javascript">
  ...
  <div class="envelope commit">
    ...
    <div id="path">
      <b><a href="/salvestrini/build-utils/tree/master">build-utils</a></b> / <a href="/salvestrini/build-utils/tree/master/m4">m4</a> / ax_prog_m4_version.m4       <span style="display:none" id="clippy_4696">m4/ax_prog_m4_version.m4</span>
      ...
      <param name="quality" value="high" />
      <param name="scale" value="noscale" />
      <param NAME="FlashVars" value="id=clippy_4696&amp;copied=copied!&amp;copyto=copy to clipboard">
      <param name="bgcolor" value="#FFFFFF">
      <param name="wmode" value="opaque">
      <embed src="http://assets0.github.com/flash/clippy.swf?v5"
             width="110"
             ...
             type="application/x-shockwave-flash"
             pluginspage="http://www.macromedia.com/go/getflashplayer"
             FlashVars="id=clippy_4696&amp;copied=copied!&amp;copyto=copy to clipboard"
             bgcolor="#FFFFFF"
             wmode="opaque"
      />
      </object>
        ...
        <div class="meta">
          <div class="info">
            ...
            <span class="mode" title="File Mode">100644</span>
              ...
              <span>66 lines (60 sloc)</span>
            
            <span>1.815 kb</span>
          </div>
          <ul class="actions">
            
              <li><a id="file-edit-link" href="#" rel="/salvestrini/build-utils/file-edit/__ref__/m4/ax_prog_m4_version.m4">edit</a></li>
            
            <li><a href="/salvestrini/build-utils/raw/master/m4/ax_prog_m4_version.m4" id="raw-url">raw</a></li>
            
              <li><a href="/salvestrini/build-utils/blame/master/m4/ax_prog_m4_version.m4">blame</a></li>
            
            <li><a href="/salvestrini/build-utils/commits/master/m4/ax_prog_m4_version.m4">history</a></li>
          </ul>
        </div>
...
<span id="LID66" rel="#L66">66</span>
          ...
          <td width="100%">
              ...
              <div class="highlight"><pre><div class='line' id='LC1'>#####</div><div class='line' id='LC2'>#</div><div class='line' id='LC3'># SYNOPSIS</div><div class='line' id='LC4'>#</div><div class='line' id='LC5'>#   AX_PROG_M4_VERSION([VERSION],[ACTION-IF-TRUE],[ACTION-IF-FALSE])</div><div class='line' id='LC6'>#</div><div class='line' id='LC7'># DESCRIPTION</div><div class='line' id='LC8'>#</div><div class='line' id='LC9'>#   Makes sure that m4 supports the version indicated. If true the</div><div class='line' id='LC10'>#   shell commands in ACTION-IF-TRUE are executed. If not the shell</div><div class='line' id='LC11'>#   commands in ACTION-IF-FALSE are run. Note if $M4 is not set (for</div><div class='line' id='LC12'>#   example by running AC_CHECK_PROG or AC_PATH_PROG) will fail.</div><div class='line' id='LC13'>#</div><div class='line' id='LC14'>#   Example:</div><div class='line' id='LC15'>#</div><div class='line' id='LC16'>#     AC_PATH_PROG([M4],[m4])</div><div class='line' id='LC17'>#     AC_PROG_M4_VERSION([1.4.0],[ ... ],[ ... ])</div><div class='line' id='LC18'>#</div><div class='line' id='LC19'>#   This will check to make sure that the m4 you have supports at</div><div class='line' id='LC20'>#   least version 1.4.0.</div><div class='line' id='LC21'>#</div><div class='line' id='LC22'>#   NOTE: This macro uses the $M4 variable to perform the check.</div><div class='line' id='LC23'>#   AX_WITH_M4 can be used to set that variable prior to running this</div><div class='line' id='LC24'>#   macro. The $M4_VERSION variable will be valorized with the</div><div class='line' id='LC25'>#   detected version.</div><div class='line' id='LC26'>#</div><div class='line' id='LC27'># LAST MODIFICATION</div><div class='line' id='LC28'>#</div><div class='line' id='LC29'>#   2008-03-12</div><div class='line' id='LC30'>#</div><div class='line' id='LC31'># COPYLEFT</div><div class='line' id='LC32'>#</div><div class='line' id='LC33'>#   Copyright (c) 2008 Francesco Salvestrini &lt;salvestrini@users.sourceforge.net&gt;</div><div class='line' id='LC34'>#</div><div class='line' id='LC35'>#   Copying and distribution of this file, with or without</div><div class='line' id='LC36'>#   modification, are permitted in any medium without royalty provided</div><div class='line' id='LC37'>#   the copyright notice and this notice are preserved.</div><div class='line' id='LC38'><br/></div><div class='line' id='LC39'>AC_DEFUN([AX_PROG_M4_VERSION],[</div><div class='line' id='LC40'>&nbsp;&nbsp;&nbsp;&nbsp;AC_REQUIRE([AC_PROG_SED])</div><div class='line' id='LC41'>&nbsp;&nbsp;&nbsp;&nbsp;AC_REQUIRE([AC_PROG_GREP])</div><div class='line' id='LC42'><br/></div><div class='line' id='LC43'>&nbsp;&nbsp;&nbsp;&nbsp;AS_IF([test -n &quot;$M4&quot;],[</div><div class='line' id='LC44'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ax_m4_require_version=&quot;$1&quot;</div><div class='line' id='LC45'><br/></div><div class='line' id='LC46'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;AC_MSG_CHECKING([for m4 version])</div><div class='line' id='LC47'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;changequote(&lt;&lt;,&gt;&gt;)</div><div class='line' id='LC48'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ax_m4_detected_version=`$M4 --version 2&gt;&amp;1 | $GREP &quot;^m4\ &quot; | $SED -e 's/.* \([0-9]*\.[0-9]*\.[0-9]*\)/\1/'`</div><div class='line' id='LC49'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;changequote([,])</div><div class='line' id='LC50'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;AC_MSG_RESULT($ax_m4_detected_version)</div><div class='line' id='LC51'><br/></div><div class='line' id='LC52'>	AC_SUBST([M4_VERSION],[$ax_m4_detected_version])</div><div class='line' id='LC53'><br/></div><div class='line' id='LC54'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;AX_COMPARE_VERSION([$ax_required_m4_version],[le],[$ax_m4_detected_version],[</div><div class='line' id='LC55'>	    :</div><div class='line' id='LC56'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$2</div><div class='line' id='LC57'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;],[</div><div class='line' id='LC58'>	    :</div><div class='line' id='LC59'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$3</div><div class='line' id='LC60'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;])</div><div class='line' id='LC61'>&nbsp;&nbsp;&nbsp;&nbsp;],[</div><div class='line' id='LC62'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;AC_MSG_WARN([could not find the m4 program])</div><div class='line' id='LC63'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$3</div><div class='line' id='LC64'>&nbsp;&nbsp;&nbsp;&nbsp;])</div><div class='line' id='LC65'>])</div><div class='line' id='LC66'><br/></div></pre></div>
      ...
      <div class="site">
        <div class="info">
          ...
          <div class="company">
            &copy;
            2010
            <span id="_rrt" title="0.33498s from fe1.rs.github.com">GitHub</span> Inc.
            All rights reserved. |
    ...
    <script>window._auth_token = "ee391411770ee9204385ef84fe602e6ca2a257dd"</script>
