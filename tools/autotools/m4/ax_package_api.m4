...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="chrome=1">
        <title>m4/ax_package_api.m4 at master from salvestrini's build-utils - GitHub</title>
    ...
    <ul class="actions">
        ...
        <li>
          ...
          <a href="/salvestrini/build-utils/toggle_watch" class="minibutton btn-watch " id="unwatch_button" style="display:none"><span><span class="icon"></span>Unwatch</span></a>
            ...
            <li class="for-notforked" style="display:none"><a href="/salvestrini/build-utils/fork" class="minibutton btn-fork " id="fork_button" onclick="var f = document.createElement('form'); f.style.display = 'none'; this.parentNode.appendChild(f); f.method = 'POST'; f.action = this.href;var s = document.createElement('input'); s.setAttribute('type', 'hidden'); s.setAttribute('name', 'authenticity_token'); s.setAttribute('value', 'd9f4370569a4ceb92cb1a1c78db2a88c0f4de2b0'); f.appendChild(s);f.submit();return false;"><span><span class="icon"></span>Fork</span></a></li>
  ...
  <ul>
    ...
    <div id="repo_details" class="metabox clearfix">
      ...
      <div id="repository_description_edit" style="display:none;" class="inline-edit">
        <form action="/salvestrini/build-utils/edit/update" method="post"><div style="margin:0;padding:0"><input name="authenticity_token" type="hidden" value="d9f4370569a4ceb92cb1a1c78db2a88c0f4de2b0" /></div>
...
<script type="text/javascript">
  ...
  <div class="envelope commit">
    ...
    <div id="path">
      <b><a href="/salvestrini/build-utils/tree/master">build-utils</a></b> / <a href="/salvestrini/build-utils/tree/master/m4">m4</a> / ax_package_api.m4       <span style="display:none" id="clippy_2728">m4/ax_package_api.m4</span>
      ...
      <param name="quality" value="high" />
      <param name="scale" value="noscale" />
      <param NAME="FlashVars" value="id=clippy_2728&amp;copied=copied!&amp;copyto=copy to clipboard">
      <param name="bgcolor" value="#FFFFFF">
      <param name="wmode" value="opaque">
      <embed src="http://assets3.github.com/flash/clippy.swf?v5"
             ...
             type="application/x-shockwave-flash"
             pluginspage="http://www.macromedia.com/go/getflashplayer"
             FlashVars="id=clippy_2728&amp;copied=copied!&amp;copyto=copy to clipboard"
             bgcolor="#FFFFFF"
             wmode="opaque"
      />
      </object>
    ...
    <div id="files">
      <div class="file">
        <div class="meta">
          <div class="info">
            <span class="icon"><img alt="Txt" height="16" src="http://assets1.github.com/images/icons/txt.png?27d77d22bfbabd036c646f149bc0923c665c0168" width="16" /></span>
            <span class="mode" title="File Mode">100644</span>
            
              <span>32 lines (30 sloc)</span>
            
            <span>1.269 kb</span>
          </div>
          <ul class="actions">
            
              <li><a id="file-edit-link" href="#" rel="/salvestrini/build-utils/file-edit/__ref__/m4/ax_package_api.m4">edit</a></li>
            
            <li><a href="/salvestrini/build-utils/raw/master/m4/ax_package_api.m4" id="raw-url">raw</a></li>
            
              <li><a href="/salvestrini/build-utils/blame/master/m4/ax_package_api.m4">blame</a></li>
            
            <li><a href="/salvestrini/build-utils/commits/master/m4/ax_package_api.m4">history</a></li>
          </ul>
        </div>
...
<span id="LID32" rel="#L32">32</span>
          ...
          <td width="100%">
              ...
              <div class="highlight"><pre><div class='line' id='LC1'># ===========================================================================</div><div class='line' id='LC2'>#        http://www.nongnu.org/autoconf-archive/ax_package_api.html</div><div class='line' id='LC3'># ===========================================================================</div><div class='line' id='LC4'>#</div><div class='line' id='LC5'># SYNOPSIS</div><div class='line' id='LC6'>#</div><div class='line' id='LC7'>#   AX_PACKAGE_API(STRING)</div><div class='line' id='LC8'>#</div><div class='line' id='LC9'># DESCRIPTION</div><div class='line' id='LC10'>#</div><div class='line' id='LC11'>#   This macro defines some versioned directory names and AC_SUBST them. The</div><div class='line' id='LC12'>#   versioned directory names depend on PACKAGE (from AC_INIT) and the STRING</div><div class='line' id='LC13'>#   passed as input parameter.</div><div class='line' id='LC14'>#</div><div class='line' id='LC15'># LICENSE</div><div class='line' id='LC16'>#</div><div class='line' id='LC17'>#   Copyright (c) 2009 Francesco Salvestrini &lt;salvestrini@users.sourceforge.net&gt;</div><div class='line' id='LC18'>#</div><div class='line' id='LC19'>#   Copying and distribution of this file, with or without modification, are</div><div class='line' id='LC20'>#   permitted in any medium without royalty provided the copyright notice</div><div class='line' id='LC21'>#   and this notice are preserved.</div><div class='line' id='LC22'><br/></div><div class='line' id='LC23'>AC_DEFUN([AX_PACKAGE_API],[</div><div class='line' id='LC24'>&nbsp;&nbsp;&nbsp;&nbsp;AC_SUBST([PACKAGE_API],[$1])</div><div class='line' id='LC25'>&nbsp;&nbsp;&nbsp;&nbsp;AC_SUBST(pkgvdir,        [&quot;\${datadir}/${PACKAGE}-${PACKAGE_API}&quot;])</div><div class='line' id='LC26'>&nbsp;&nbsp;&nbsp;&nbsp;AC_SUBST(pkgvbindir,     [&quot;\${datadir}/${PACKAGE}-${PACKAGE_API}/bin&quot;])</div><div class='line' id='LC27'>&nbsp;&nbsp;&nbsp;&nbsp;AC_SUBST(pkgvlibsdir,    [&quot;\${datadir}/${PACKAGE}-${PACKAGE_API}/libs&quot;])</div><div class='line' id='LC28'>&nbsp;&nbsp;&nbsp;&nbsp;AC_SUBST(pkgvdatadir,    [&quot;\${datadir}/${PACKAGE}-${PACKAGE_API}/data&quot;])</div><div class='line' id='LC29'>&nbsp;&nbsp;&nbsp;&nbsp;AC_SUBST(pkgvincludedir, [&quot;\${includedir}/${PACKAGE}-${PACKAGE_API}&quot;])</div><div class='line' id='LC30'>&nbsp;&nbsp;&nbsp;&nbsp;AC_SUBST(pkgvpythondir,  [&quot;\${pythondir}/${PACKAGE}-${PACKAGE_API}&quot;])</div><div class='line' id='LC31'>])</div><div class='line' id='LC32'><br/></div></pre></div>
      ...
      <div class="site">
        <div class="info">
          ...
          <div class="company">
            &copy;
            2010
            <span id="_rrt" title="0.03874s from fe1.rs.github.com">GitHub</span> Inc.
            All rights reserved. |
    ...
    <script>window._auth_token = "d9f4370569a4ceb92cb1a1c78db2a88c0f4de2b0"</script>
